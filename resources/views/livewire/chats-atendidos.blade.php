    ...
    <ul class="list bg-base-100 rounded-box shadow-md max-h-full overflow-y-auto">
        ...
        <li class="list-row">
            ...
            <div>
                ...
                <div>
                    <p class="list-col-wrap text-xs">Último mensaje, uno muy largo, uyuyuyuy, mamma mía lo largo que es oyy dios mío esto es demasiado tocho no me va a caber ay madre jolín</p>
                </div>
            </div>
        </li>
        <li class="list-row">
